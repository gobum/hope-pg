...
\set to_job '\\set error 0 \\set JOB 1 \\set SQL 1 \\set DID 0 \\set ACT 0 \\set ROW 0 \\set ASS 0 '
\set to_act '\\set ACT 1 '
\set to_did '\\set DID 1 \\set ACT 1'
\set to_end '\\set error 0 \\set JOB 0 \\set SQL 1 \\set DID 1 \\set ACT 1 \\set ROW 0 \\set ASS 0 '
:to_end
...
\set gxe :t1 :log:d '\\gset' :log:z :t0
...
-- :Done 结束测试用例
\set Done '\\if :JOB \\if :ROW ' :do_row ' \\elif :ASS ' :do_ass ' \\else ' :cmd :exe ' \\endif ' :log :z:s_done :to_end ' \\else ' :err :e_done:z ' \\q \\endif\\\\ '

\o /dev/null

:log 'Import hope.sql\n\n'

\unset do_ass \unset do_row \unset do_fail \unset do_pass 
\unset ass \unset row \unset gxe \unset exe \unset cmd \unset err \unset log

\unset t1 \unset t0 \unset to_end \unset to_did \unset to_act \unset to_job 
\unset e_done \unset e_rows \unset e_assert \unset e_fail \unset e_pass \unset e_hope \unset e_include
\unset s_done \unset s_rows \unset s_assert \unset s_fail \unset s_pass \unset s_hope \unset s_include
